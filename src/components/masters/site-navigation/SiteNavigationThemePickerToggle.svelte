...
<button class="flex size-[32px] items-center justify-center rounded-full bg-dynamic-neutral-200 fill-dynamic-neutral-800" on:click={toggleSiteNavigationThemePicker}>
